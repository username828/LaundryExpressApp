  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="OnBoarding">
        ...
        <Stack.Screen name="OrderPlacement" component={PlaceOrderScreen} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="Rating" component={CustomerFeedbackScreen} options={{ headerShown: false }} />
        <Stack.Screen name="ServiceProviderAuth" component={SPAuthScreen} options={{ headerShown: false }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
